 ...
 *
 * <p><b>Prerequisites:</b>
 * This code requires the Envoy Protocol Buffer dependencies (e.g., 'io.envoyproxy.controlplane:api').
 * It uses Google Default Credentials, so it should be run in an environment with ALTS (like a GCP VM)
            ...
            StreamObserver<DiscoveryResponse> responseObserver =
                    new StreamObserver<DiscoveryResponse>() {
                        ...
                        public void onNext(DiscoveryResponse value) {
                            ...
                            LOG.info("Version Info: " + value.getVersionInfo());
                            LOG.info("Nonce: " + value.getNonce());
                            LOG.info("Resources Count: " + value.getResourcesCount());
                            LOG.info("Type URL: " + value.getTypeUrl());
                            // Print the resources (Listeners)
                            value.getResourcesList().forEach(any -> LOG.info("Resource: " + any));
                            latch.countDown(); // Release latch after receiving response
                        }
